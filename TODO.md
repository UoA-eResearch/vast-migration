...
- Remove all test code and flags before running in production
...
- Determine the `research_drives_root` path in production Vast where the views should be created
- Coordinate with the Unifiles migration to ensure that the data is migrated, and that the directories are created in Vast as expected